...
class TestGitHubURLs(unittest.TestCase):
    ...
    def test_allow_https_rule_from_raw_github(self):
        good_url = 'https://raw.githubusercontent.com/np-guard/baseline-rules/master/examples/allow_https_egress.yaml'
        blr = BaselineRules([good_url])
        self.assertEqual(blr[0].port_min, 443)
